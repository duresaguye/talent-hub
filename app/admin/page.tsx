...
import { Users, Briefcase, FileText, Building, TrendingUp, AlertCircle } from "lucide-react"
...
const recentActivity = [
  {
    id: 1,
    action: "New employer registered: TechCorp Inc.",
    date: "2 hours ago",
    type: "user",
  },
  {
    id: 2,
    action: "Job posted: Senior Frontend Developer",
    date: "4 hours ago",
    type: "job",
  },
  {
    id: 3,
    action: "Application submitted for Product Manager role",
    date: "6 hours ago",
    type: "application",
  },
  {
    id: 4,
    action: "User reported inappropriate job posting",
    date: "8 hours ago",
    type: "report",
  },
]
                    ...
                    {recentActivity.map((activity) => (
                      <div key={activity.id} className="flex items-start gap-3 p-3 rounded-lg border">
                        <div className="mt-1">
                          ...
                          {activity.type === "job" && <Briefcase className="h-4 w-4 text-green-500" />}
                          {activity.type === "application" && <FileText className="h-4 w-4 text-purple-500" />}
